...
public:
	RigidBody(physx::PxPhysics* ph, physx::PxScene* mScene, Vector3 pos, physx::PxActorType::Enum type, physx::PxShape* shape, double density, Vector4 color, double life_time, BoundingBox const& pos_limits, Vector3 velocity = Vector3(0.0f));
	virtual ~RigidBody();
