...
extern int display_text_x, display_text_y;
extern float display_text_color_r, display_text_color_g, display_text_color_b, display_text_color_a;
extern void setTextPos(int x, int y);
extern void setTextColor(float r, float g, float b, float a = 1.0f);
